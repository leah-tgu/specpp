...
public class SupervisionConfiguration extends Configuration {
    ...
    public SupervisionConfiguration(ComponentSystemAdapter csa, List<SimpleBuilder<Supervisor>> supervisorBuilders) {
        super(csa);
    ...
    public static class Configurator implements ComponentInitializerBuilder<SupervisionConfiguration> {
        ...
        @Override
        public SupervisionConfiguration build(ComponentSystemAdapter csa) {
