package org.processmining.estminer.implicitplaceremoval;
...
public class OptimizationBasedImplicitPlaceRemover extends AbstractImplicitPlacesRemover {
    ...
    public OptimizationBasedImplicitPlaceRemover(String[] transitions, MyLog log) {
        super(transitions, log);
    }

    //removes all structurally implicit places in the givn pM (the relevant Trace variants are ignored)
    public MyProcessModel removeAllIPs(MyProcessModel pM, ArrayList<ArrayList<Integer>> relevantTraceVariants) {
        //compute all the stuff needed for the LPP
        ArrayList<MyPlace> places = (ArrayList<MyPlace>) pM.getPlaces().clone();
        final ArrayList<MyPlace> finalPlaces = new ArrayList<MyPlace>();
        ...
        ArrayList<MyPlace> tempPlaces = (ArrayList<MyPlace>) places.clone();
    ...
    public ArrayList<MyPlace> implicitRelatedToPlace(MyPlace currentP, ArrayList<MyPlace> places, ArrayList<ArrayList<Integer>> relevantTraceVariants) {
    ...
    private boolean isImplicitByLPP(int currP, ArrayList<MyPlace> places, String[] transitions,
                                    ArrayList<Integer[]> preIncMatrix, ArrayList<Integer[]> incMatrix) {
    ...
    public Object[] implicitAndRepairRelatedToPlace(MyPlace specificPlace, ArrayList<MyPlace> placesToCheck,
                                                    ArrayList<ArrayList<Integer>> relevantTraceVariants) {
        System.out.println("ERROR: IP Removal with repair not imlemented!");
        // TODO Auto-generated method stub
        return null;
