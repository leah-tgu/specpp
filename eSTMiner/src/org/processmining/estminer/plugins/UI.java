...
public class UI extends ProMPropertiesPanel implements ProMWizardStep<Parameters> {
    ...
    public UI(XLog log) {
        ...
        this.threshold_tau = SlickerFactory.instance()
                                           .createNiceDoubleSlider("Threshold Tau ", 0, 1, 0.75, Orientation.HORIZONTAL);
        this.add(this.threshold_tau);

        //configure threshold delta
        this.threshold_delta = SlickerFactory.instance()
                                             .createNiceDoubleSlider("Threshold Delta ", 0, 1, 0.05, Orientation.HORIZONTAL);
        ...
        this.deltaAdaptionSteepness = SlickerFactory.instance()
                                                    .createNiceIntegerSlider("Delta Adaption Steepness: ", 1, 100, 4, Orientation.HORIZONTAL);
        this.add(this.deltaAdaptionSteepness);

        //configure virtual tree traversal depth (delta discovery)
        this.virtualTreeDepth = SlickerFactory.instance()
                                              .createNiceIntegerSlider("Virtual Tree Depth Modifier: ", 1, 100, 2, Orientation.HORIZONTAL);
        ...
        this.PotentialPlacesMaxLength = SlickerFactory.instance()
                                                      .createNiceIntegerSlider("Potential places max (delta discover): ", 0, 10000, 1000, Orientation.HORIZONTAL);
        ...
        this.treeDepth = SlickerFactory.instance()
                                       .createNiceIntegerSlider("Max Number of Transitions: ", 1, 20, 4, Orientation.HORIZONTAL);
