package org.processmining.estminer.headless;
...
import org.processmining.estminer.plugins.ESTMinerPlugin;
...
public class MainCluster {
    ...
    public static void main(String[] args) {
        ...
        // ???
        ArgumentParser parser = ArgumentParsers.newFor("Delta Discovery")
                                               .build()
                                               .description("Configure eST Delta Discovery precomputation parameters.");
        ...
        parser.addArgument("--delta_adaption_strategy")
              .type(String.class)
              .help("Sigmoid, Linear, NoDelta, or MaxDelta");
        ...
        parser.addArgument("--tree_traversal_strategy")
              .type(String.class)
              .setDefault("BFS")
              .help("BFS (Uniwired, Delta) or DFS (Classic).");
        parser.addArgument("--discovery_variant")
              .type(String.class)
              .setDefault("Delta")
              .help("Classic, Uniwired or Delta.");
