...
public class Spliteration {
    ...
    public static <T> CompatiblePairSpliteratorImpl<IndexedItem<T>, IndexedItem<Pair<T>>> joinIndexedSpliterators(Spliterator<IndexedItem<T>> spliteratorA, Spliterator<IndexedItem<T>> spliteratorB) {
